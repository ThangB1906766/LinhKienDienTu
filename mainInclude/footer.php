            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="row text-center">
                        ...
                        <div class="col-sm">
                            <h5>Hỗ Trợ</h5>
                            <a class="text-dark" href="#">0111222333</a><br />
                        </div>
...
<footer class="container-fluid bg-dark text-center p-2">
    <small class="text-white">Copyright &copy; 2023 || LinhKienDienTu || 
        <?php 
            if(isset($_SESSION['is_admin_login'])){
                echo '<a href="admin/adminDashboard.php"> Admin Dashboard</a> <a href="logout.php">Logout</a>';
            }else{
                echo '<a href="#" data-toggle="modal" data-target="#adminLoginModal">Admin Login</a></small>';
            }
        ?>
