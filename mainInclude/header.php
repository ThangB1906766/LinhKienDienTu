...
<body>
    ...
    <nav class="navbar navbar-expand-sm" style="background-color: #007bff; border-radius: 10px; margin: 5px;">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php">LinhKienDienTu</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <ul class="navbar-nav custom-nav px-5 me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item custom-nav-item"><a href="index.php" class="nav-link">Products</a></li>
                        ...
                        <ul>
                            <?php
                                ...
                                if(isset($_SESSION['is_login'])){
                                    echo '
                                        <li ><a href="Student/thongTinNguoiMua.php" class="sub-menu-link"">My Profile</a></li> 
