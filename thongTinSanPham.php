...
<div class="productContainer">
                    ...
                    <div class="row">
                                ...
                                <div class="col-md-8">
                                  <div class="card-body">
                                      ...
                                      <p class="card-text">Giá:  <span class="font-weight-bolder"> '.$row['sp_gia'].' &#8363;<span></p>
    ...
    <div class="row container mt-4" style="background: #f5fff0;">
        <?php
            $sp_id = $_GET['sp_id'];
            ...
            if($result->num_rows > 0){ 
                ...
                echo ' 
                    ...
                    <a href="coursedetail.php?sp_id='.$sp_id.'" class="btn" style="text-align: left; padding:0px;">
                    <div class="card cardHolder">
                        ...
                        <p class="card-text d-inline">Giá: <small></small> <span class="font-weight-bolder">&#8363; '.$row['sp_gia'].'<span></p> <a href="coursedetails.php?sp_id='.$sp_id.'"></a>
                        </div>
                    </div> </a>
                    </div>
                ';
